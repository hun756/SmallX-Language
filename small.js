...
var grammar = {
    ...
    {"name": "lambda$ebnf$1$subexpression$1", "symbols": ["_", "param_list", "_"]},
    ...
    {"name": "lambda", "symbols": [{"literal":"("}, "lambda$ebnf$1", {"literal":")"}, "_", {"literal":"=>"}, "_", "lambda_body"], "postprocess": 
        (data) => {
            return {
                type: "lambda",
    ...
    {"name": "lambda_body", "symbols": ["_", (myLexer.has("NL") ? {type: "NL"} : NL), {"literal":"{"}, "_", (myLexer.has("NL") ? {type: "NL"} : NL), "statements", (myLexer.has("NL") ? {type: "NL"} : NL), "_", {"literal":"}"}, "_", (myLexer.has("NL") ? {type: "NL"} : NL)], "postprocess": 
        (data) => {
            return data[3];
        }
                },
